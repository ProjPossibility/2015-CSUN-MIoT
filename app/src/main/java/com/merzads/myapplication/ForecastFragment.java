...
import static com.merzads.myapplication.R.id.list_item_forecast_textview;

/**
 * Created by Mehrzadshabez on 2/12/2015.
 */
public class ForecastFragment extends Fragment {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        if(item.getItemId() == R.id.action_refresh)
        {
            ...
            weatherTask.execute("91402");
            speakText("this is test");
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       weekForecast = new ArrayList<String>(Arrays.asList(forecastArray));
        weekForecast.add("todays weather");

         mAdaptor = new ArrayAdapter<String>(getActivity(),
                R.layout.list_item_forecast, list_item_forecast_textview, weekForecast);
    ...
    public void speakText(String Q){
...
// so that they can be closed in the finally block.
...

            {
                ...
                Log.v("logging URI", builtUri.toString());
                ...
                Log.v("Json Tag", forecastJsonStr);
             //   String forecast[] = getWeatherDataFromJson(forecastJsonStr, 1);
             //   Log.v( "realdata", forecast[0]);
            } catch (
                    IOException e
                    )
